...
class NotificationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.settings.notification.index')->with([
            ...
            'env'             => $this->editor->getKeys($keys->toArray())
        ]);
    }
    ...
    public function updateTemplate(Request $request)
    {
        ...
        if($template = $templates->first()){
            ...
            return success_response($request, __("Your template has been updated!"));

        }else{
            return error_response($request, __("Template could not be found!"));
        }
