        ...
        <div class="card-body">
            ...
            <div class="form-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        {!! Form::select('BITGO_ENV', ['test' => 'Test', 'prod' => 'Production'], $env['BITGO_ENV']['value'], ['is' => 'select2', 'class' => 'form-control']) !!}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        {!! Form::text('BITGO_TOKEN', $env['BITGO_TOKEN']['value'], ['class' => 'form-control']) !!}
                        <small class="help-block">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        {!! Form::text('BITGO_HOST', $env['BITGO_HOST']['value'], ['class' => 'form-control']) !!}
                        <small class="help-block">
