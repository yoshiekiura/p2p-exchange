        ...
        <div class="card-body">
            ...
            <div class="form-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        {!! Form::select('NOCAPTCHA_ENABLE', ['true' => 'Yes', 'false' => 'No'], $env['NOCAPTCHA_ENABLE']['value'], ['is' => 'select2', 'class' => 'form-control']) !!}
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        {!! Form::select('NOCAPTCHA_TYPE', ['v2' => 'V2', 'invisible' => 'Invisible'], $env['NOCAPTCHA_TYPE']['value'], ['is' => 'select2', 'class' => 'form-control']) !!}
                    </div>
                </div>
