        ...
        <div class="card-body">
            ...
            <div class="tab-content px-1 pt-1">
                <div role="tabpanel" class="tab-pane active" id="komodo-address"
                    ...
                    @if(Auth::user()->wallet('kmd')->latestAddress())
                        <div class="row">
                            <div class="col-sm-6 py-1 text-center">
                                {!! HTML::image(Auth::user()->wallet('kmd')->latestAddressQRCode(), null, ['class' => 'img-thumbnail']) !!}
                            </div>
                            <div class="col-sm-6 py-4 text-center">
                                ...
                                <div class="card-text text-center pt-1">
                                    <h2><b>{{Auth::user()->wallet('kmd')->latestAddress()}}</b></h2>
                                </div>
                                ...
                                <div class="modal fade text-left" id="send-komodo" tabindex="-1" role="dialog" aria-labelledby="send-komodo-label"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        {!! Form::open(['url' => route('wallet.send', ['coin' => 'kmd']), 'class' => 'form form-horizontal', 'method' => 'POST']) !!}
                                            ...
                                            <div class="modal-body">
                                                <div class="form-body">
                                                    <h3 class="text-center">
                                                        {{__('Available:')}} {{Auth::user()->wallet('kmd')->totalAvailable()}} KMD
                                                    </h3>
                                                    <hr>
                                                    <div class="form-group row">
                                                        <label class="col-md-4">{{__('Value')}}</label>
                                                        <div class="col-md-8">
                                                            {!! Form::text('amount', null, ['class' => 'form-control', 'v-model.number' => 'send.kmd_value', 'placeholder' => Auth::user()->wallet('kmd')->totalAvailable(), 'novalidate']) !!}
                    ...
                    <div class="row pt-1">
                        <button class="btn btn-secondary mx-auto col-lg-8 btn-lg my-1 btn-block"
                                ...
                                type="button" href="{{route('wallet.generate-address', ['coin' => 'kmd'])}}">
